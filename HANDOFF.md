...
- **673 / 673 tests pass** (`ctest --test-dir build/debug`), Debug
  build with ASan + UBSan via the `asan` preset, format-check clean.
- Tip commit: `594662f sema+codegen: §A11 follow-on — Padded[T] cache-line wrapper`.
