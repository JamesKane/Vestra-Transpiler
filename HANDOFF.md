...
- **662 / 662 tests pass** (`ctest --test-dir build/debug`), Debug
  build with ASan + UBSan via the `asan` preset, format-check clean.
- Tip commit: `0e0a548 sema+codegen: §A3 follow-up — Ptr / MutPtr .value dereference`.
