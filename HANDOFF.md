...
- **615 / 615 tests pass** (`ctest --test-dir build/debug`), Debug
  build with ASan + UBSan via the `asan` preset, format-check clean.
- Tip commit: `824946c sema+codegen: §A6 follow-up — MmioWireView[T] (endianness)`.
