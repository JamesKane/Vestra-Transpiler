...
- **645 / 645 tests pass** (`ctest --test-dir build/debug`), Debug
  build with ASan + UBSan via the `asan` preset, format-check clean.
- Tip commit: `1e3b812 sema+codegen: §A10 follow-up — memcpy / memset / memmove intrinsics`.
