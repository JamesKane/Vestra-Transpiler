...
- **636 / 636 tests pass** (`ctest --test-dir build/debug`), Debug
  build with ASan + UBSan via the `asan` preset, format-check clean.
- Tip commit: `4747e88 sema+codegen: §A8 follow-up — typed vector tables`.
