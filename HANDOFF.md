...
- **701 / 701 tests pass** (`ctest --test-dir build/debug`), Debug
  build with ASan + UBSan via the `asan` preset, format-check clean.
- Tip commit: `12882e7 codegen: §14.12 second slice — auto-emitted post-write barriers`.
