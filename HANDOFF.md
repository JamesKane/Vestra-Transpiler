...
- **652 / 652 tests pass** (`ctest --test-dir build/debug`), Debug
  build with ASan + UBSan via the `asan` preset, format-check clean.
- Tip commit: `e6883e5 sema+codegen: §A11 follow-up — PerCpu.new + slot(hartId)`.
