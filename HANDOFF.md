...
- **707 / 707 tests pass** (`ctest --test-dir build/debug`), Debug
  build with ASan + UBSan via the `asan` preset, format-check clean.
- Tip commit: `44f17ab sema: §9 .mapError closure-literal context propagation`.
