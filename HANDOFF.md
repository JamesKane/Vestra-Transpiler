...
- **688 / 688 tests pass** (`ctest --test-dir build/debug`), Debug
  build with ASan + UBSan via the `asan` preset, format-check clean.
- Tip commit: `fc0512b sema+codegen+cli: §A10 follow-up — @stack_protector + --no-libc`.
